...
const DEMO_KEYS = {
  ...
  async function useDemoAccount(role, user) {
    try {
      ...
      let privateKey = DEMO_KEYS[role];

      if (username === "sudeep" || fullName.includes("sudeep")) {
        account = "0x70997970C51812dc3A010C7d01b50e0d17dc79C8";
        privateKey = "0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d";
      } else if (username === "raj" || username === "boss" || fullName.includes("raj")) {
        account = "0x90F79bf6EB2c4f870365E785982E1f101E93b906";
        privateKey = "0x7c852118294e51e653712a81e05800f419141751be58f605c371e15141b007a6";
      } else if (username === "hemant" || fullName.includes("hemant")) {
      ...
      setForm((current) => ({ ...current, owner: account, buyer: account.toLowerCase() === DEMO_ACCOUNTS.buyer.toLowerCase() ? "0x90F79bf6EB2c4f870365E785982E1f101E93b906" : DEMO_ACCOUNTS.buyer }));
      setMessage(`${user?.fullName || role} connected to local blockchain (${shortAddress(account)}).`);
  ...
  async function findLand(landId = form.lookupId) {
    ...
    try {
      ...
      if (!foundVariant || !result) {
        setMessage(`Land ID #${landId} has not been registered on the blockchain yet.`);
        setLand(null);
        return null;
      }
      ...
      setMessage(`Land record #${landId} loaded from blockchain (${foundVariant === "optimized" ? "Optimized" : "Base"} contract).`);
      return item;
    } catch {
      setMessage(`Unable to retrieve land record #${landId}.`);
      setLand(null);
      return null;
    }
  }
